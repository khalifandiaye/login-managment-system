...
public class UserEdit extends AbstractFileWebTemplate{

	public UserEdit() throws KeyException, IOException {
		super();
	}
	...
	protected void doRender(Object object, HttpServletRequest request,
		...
		getHolder().setValue( "userid", this.getParameter( "userid" ).toString() );
